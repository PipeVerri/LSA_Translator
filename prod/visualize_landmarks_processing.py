...
from utils.mp_utils.render import draw_landmarks_from_array
import cv2
...
with mp.solutions.holistic.Holistic(model_complexity=2, static_image_mode=False) as holistic:
    ...
    for frame in camera_reader(fps=6):
        ...
        img = draw_landmarks_from_array(np.zeros(frame.shape), pose, connections=mp.solutions.pose.POSE_CONNECTIONS)
